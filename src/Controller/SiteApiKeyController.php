...
/**
 * @file
 * Contains \Drupal\custom_site_info\Controller\SiteApiKeyController.
 */
...
class SiteApiKeyController{
    ...
    public function content($site_api_key, NodeInterface $node){
        ...
        return new JsonResponse(array("error" => "access denied.Please provide valid input."), 401, ['Content-Type'=> 'application/json']);
    }
}